...
Oftentimes, we need to tidy data into the “long format” in order to be
able to plot it
nicely
...
In litters data, the group variable combines the “intervention”
variables and “day” variables (con7, con8, etc). We need to separate
this
...
sometimes you want wider format as opposed to long-format (i.e. when you
need to find differences, etc)
